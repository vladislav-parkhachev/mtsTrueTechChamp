...
namespace maze_solver
{
    ...
    public:
        ...
        std::array<int, 2> DFSAlgorithmFinish(std::array<int, 2> start);
...
{
    cpr::Post(cpr::Url{"http://127.0.0.1:8801/api/v1/robot-motors/move?l=50&l_time=2.9&r=50&r_time=2.9"},
              cpr::Body{""},
              cpr::Header{{"accept", "application/json"}});
...
{
    cpr::Post(cpr::Url{"http://127.0.0.1:8801/api/v1/robot-motors/move?l=-200&l_time=1.55&r=200&r_time=1.55"},
              cpr::Body{""},
              cpr::Header{{"accept", "application/json"}});
